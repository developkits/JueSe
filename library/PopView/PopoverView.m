...
#define kDividerColor MAIN_COLOR


#define TAPPED_HILIGHT_COLOR MAIN_COLOR

// BACKGROUND GRADIENT

//内容视图背景色
#define CONTENT_BACL_COLOR [UIColor clearColor]
//top color white value in gradient bg
#define kGradientTopColor [UIColor colorWithWhite:0.9 alpha:0.85]
//bottom color white in gradient bg
#define kGradientBottomColor [UIColor colorWithWhite:0.9 alpha:0.85]


// TITLE GRADIENT

//bottom color white value in title gradient bg
#define kGradientTitleBottomColor [UIColor colorWithWhite:0.9 alpha:0.85]


//top color white value in title gradient bg
#define kGradientTitleTopColor [UIColor colorWithWhite:0.9 alpha:0.85]
...
//title font
#define kTitleFont [UIFont fontWithName:@"HelveticaNeue" size:18.f]
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray {
    ...
    float totalHeight =(SHOW_TITLE?(titleSize.height+ titleHeightOffset+ kBoxPadding):0);
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withContentView:(UIView *)cView {
    ...
    contentView.backgroundColor=CONTENT_BACL_COLOR;
    ...
    for(int i = 0; i < subviewsArray.count && !found; i++) {
        ...
        if(CGRectContainsPoint(view.frame, point)) {
            ...
            if([view isKindOfClass:[UILabel class]]) {
                ...
                label.backgroundColor =TAPPED_HILIGHT_COLOR;
